    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מוטי שוחט טיפול משנה חיים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '8452ef87-3a97-498f-ab2a-a2c0d78fce17',
                    name: data.name || '',
                    email: data.email || '',
